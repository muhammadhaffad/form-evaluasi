					...
					<?php foreach ($section['section_sub'] as $data): ?>
						...
						<?php foreach ($data['indikator'] as $key => $sub): ?>
							...
							<tr>
								...
								<td data-section-id="<?= $section['section_id'] ?>" data-section-sub-id="<?= $data['section_sub_id'] ?>" data-indikator-id="<?= $sub['indikator_id'] ?>" rowspan="<?= count($sub['indikator_kriteria']) ?>" class="indikator-bobot-eval-<?= $section['section_id'] ?>-<?= $data['section_sub_id'] ?>-<?= $sub['indikator_id'] ?> block md:table-cell md:border border-t border-t-gray-200 dark:border-gray-700 px-6 py-3">
									<?= $sub['indikator_skor'] ?>
								</td>
								<?php if ($key == 0): ?>
									<td data-section-id="<?= $section['section_id'] ?>" data-section-sub-id="<?= $data['section_sub_id'] ?>" rowspan="<?= count($sub['indikator_kriteria']) * count($data['indikator']) ?>" class="section-sub-total-bobot-<?= $section['section_id'] ?>-<?= $data['section_sub_id'] ?> hidden md:table-cell md:border dark:border-gray-700 px-6 py-3">
										<?= $data['section_sub_skor'] ?>
									</td>
									<td data-section-id="<?= $section['section_id'] ?>" data-section-sub-id="<?= $data['section_sub_id'] ?>" rowspan="<?= count($sub['indikator_kriteria']) * count($data['indikator']) ?>" class="section-sub-kategori-<?= $section['section_id'] ?>-<?= $data['section_sub_id'] ?> uppercase hidden md:table-cell md:border dark:border-gray-700 px-6 py-3">
										<?= $data['section_sub_skor_kategori'] ?>
									</td>
									<td data-section-id="<?= $section['section_id'] ?>" data-section-sub-id="<?= $data['section_sub_id'] ?>" rowspan="<?= count($sub['indikator_kriteria']) * count($data['indikator']) ?>" class="section-sub-result-<?= $section['section_id'] ?>-<?= $data['section_sub_id'] ?> hidden md:table-cell md:border dark:border-gray-700 px-6 py-3">
										<?= $data['section_sub_skor_result'] ?>
									</td>
								<?php endif; ?>
							</tr>
						...
						<?php endforeach; ?>
						<tr class="md:hidden">
							<td data-section-id="<?= $section['section_id'] ?>" data-section-sub-id="<?= $data['section_sub_id'] ?>" class="section-sub-total-bobot-<?= $section['section_id'] ?>-<?= $data['section_sub_id'] ?> bg-gray-700/10 dark:bg-gray-700/20 block md:border dark:border-gray-700 px-6 py-3" data-label="Total Bobot">
								<?= $data['section_sub_skor'] ?>
							</td>
							<td data-section-id="<?= $section['section_id'] ?>" data-section-sub-id="<?= $data['section_sub_id'] ?>" class="section-sub-kategori-<?= $section['section_id'] ?>-<?= $data['section_sub_id'] ?> uppercase bg-gray-700/10 dark:bg-gray-700/20 block md:border dark:border-gray-700 px-6 py-3" data-label="Kategori">
								<?= $data['section_sub_skor_kategori'] ?>
							</td>
							<td data-section-id="<?= $section['section_id'] ?>" data-section-sub-id="<?= $data['section_sub_id'] ?>" class="section-sub-result-<?= $section['section_id'] ?>-<?= $data['section_sub_id'] ?> bg-gray-700/10 dark:bg-gray-700/20 block md:border dark:border-gray-700 px-6 py-3" data-label="Nilai Akhir">
								<?= $data['section_sub_skor_result'] ?>
							</td>
						</tr>
					<?php endforeach; ?>
