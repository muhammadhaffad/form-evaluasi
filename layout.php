...
<body class="bg-gray-100 dark:bg-gray-900">
    <main class="max-w-[1400px] overflow-hidden w-full mx-auto p-5 space-y-4">
        ...
        <nav>
            <div class="p-2 shadow-lg rounded-lg grid grid-cols-1 md:grid-cols-3 gap-2 bg-white dark:bg-gray-800">
                ...
                <button type="button" class="<?= $active == 'tutorial' ? 'flex items-center gap-2 justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800' : 'text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700' ?>" onclick="window.location.href='tutorial.php'">
